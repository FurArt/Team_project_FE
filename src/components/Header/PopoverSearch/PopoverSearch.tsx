...
//   // const [content, setContent] = useState(movies?.title?.content)
//   const [content, setContent] = useState([]);
//   // const content = movies?.title?.content || []
//   const [search, setSearch] = useState("")
//   const [searchMovie, setSearchMovies] = useState< ContentItem | null>(null);
...
//       setContent(movies?.title?.content?.slice().sort((a, b) => a.title.localeCompare(b.title)))
//     }
...
//     } else {
//       const filteredMovies: ContentItem[] = content?.filter(movie =>
