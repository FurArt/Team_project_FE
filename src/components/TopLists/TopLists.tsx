...
const topLists = [
  {
    ...
    image:
      "http://localhost:5173/Team_project_FE/src/images/actor-top-list.jpg",
  },
  {
      ...
      <div className="top-lists-container">
        ...
        <ul className="top-lists-menu">
          {topLists.map((item, index) => (
            ...
            >
              <span className="top-lists-text">{`0${index + 1}.`} {item.title}</span>
            </li>
          ))}
        </ul>
        ...
        <div className="top-lists-image">
          <img
            src={selectedIndex !== null ? topLists[selectedIndex].image : "/images/default.jpg"}
            alt="Actor holding an award"
            className="top-lists-actor-image"
          />
          <div className="top-lists-overlay"></div>
